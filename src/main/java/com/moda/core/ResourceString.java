...
public class ResourceString {
    ...
    protected static final String[] BH_360_GROUPS = {"OEBB", "CPH", "SPH", "Leatherman", "Trailblazer"};
    protected static final String[] WITHOUT_BH_360_GROUPS = { "PEBB", "Salem Health", "OHSU"};
